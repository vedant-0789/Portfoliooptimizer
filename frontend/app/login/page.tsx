  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Fix: Handle Pydantic error array or string
        if (typeof errorData.detail === 'string') {
          setError(errorData.detail)
        } else if (Array.isArray(errorData.detail)) {
          // Extract messages from array of objects
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                required
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent text-black bg-gray-50"
                style={{ color: 'black' }}
